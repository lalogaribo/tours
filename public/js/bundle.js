      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            (0, _alerts.showAlert)('success', 'You successfully logged out');
            _context2.next = 11;
            break;
...
var profile = 'Profile was updated succesffully';
var password = 'Password was successully changed';

var updateUserInformation =
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            res = _context.sent;
            (0, _alerts.showAlert)('success', "".concat(type === 'password' ? password : profile));
            _context.next = 11;
            break;
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'Unable to update profile! Try again later');
  ...
  return function updateUserInformation(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibGFsaXRvZ3VhcGl0byIsImEiOiJjazBjdWRzd2MwMTd3M25tbXVwbTRsaHkwIn0.RKMg0UlxRUfBktpOCRGjag';
...
var stripe = Stripe('pk_test_2cowrcK24Y3m409yC60OD5N000mNIXWT2y');
...
var pswForm = document.querySelector('.form-user-settings');
...
if (userForm) {
  document.querySelector('.form').addEventListener('submit', function (e) {
    ...
    (0, _updateUser.updateUserInformation)(form, 'updateMe');
    console.log(form);
  });
} // if (pswForm) {
